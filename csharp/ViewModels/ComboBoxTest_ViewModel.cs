using MvvmSilverlightApplication.Models;
using MvvmSilverlightApplication.ViewModels.Common;
using MvvmSilverlightApplication.ViewModels.Common.Base;
...
namespace MvvmSilverlightApplication.ViewModels
{
